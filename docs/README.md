...
Browse the searchable site at:

```text
https://xioaisolutions.github.io/CrumbContext/
```

Repository Markdown remains the source of truth. The site is generated by `scripts/build_docs.py`, uses local search, and loads no analytics or third-party runtime scripts.
