...
def replace_once(path: str, old: str, new: str, sentinel: str) -> None:
    ...
    if count != 1:
        raise RuntimeError(f"{path}: marker count for {old!r} was {count}")
